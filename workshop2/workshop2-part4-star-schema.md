...
1. Run the below prompt
   ...
   - Examples: `gold_fact_sales`, `gold_dim_customer`, `gold_dim_product`.
...
3. Enter `implement create_star_schema.md`
4. Once the implementation is over then navigate to pipeline folder and run
